...
<body>
    <x-guest-layout>
        ...
        <div class="login-form-container flex justify-center px-4 mt-10"> <!-- Added mt-10 to add margin at the top -->
            <!-- First column for image -->
            <div class="w-1/2">
                <img src="public/assets/phlpostrrr logo.png" alt="PhilPost Office Logo" width="100">
            </div>
            ...
            <div class="w-1/2">
                <form method="POST" action="{{ route('login') }}" class="mx-auto max-w-md"> <!-- Added mx-auto and max-w-md to center the form and limit its width -->
                    ...
                    <!-- Remember Me -->
                    <div class="form-group mb-2.5 flex items-center"> <!-- Added margin and flex to align items -->
                        <label for="remember_me" class="inline-flex items-center mr-4"> <!-- Added mr-4 for margin -->
                            <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 w-4 h-4" name="remember"> <!-- Removed h-4 class -->
